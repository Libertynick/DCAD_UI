...
class AuthorizationDcadPage(BasePage):
    """
    Страница Авторизация DCAD
    """

    NAME_PAGE = '|Авторизация DCAD|'
    ...
    def should_header_visible(self) -> None:
        ...
        with allure.step(f'{self.NAME_PAGE} Проверка отображения формы авторизации'):
    ...
    def click_btn_submit(self) -> None:
        ...
        with allure.step(f'{self.NAME_PAGE} Клик по кнопке Войти'):
